...
/**
 * Logging utility class that provides simple access to the JDK Logging API. Set the "java.util.logging.config.file"
 * system property to specify the location of the desired logging configuration file. A sample configuration file is
 * available at {@code src/main/config/logging.properties}.
 * 
 * @see java.util.logging.LogManager LogManager
 */
public final class TestSuiteLogger {
    ...
    /**
     * Logs a message at the specified logging level with the given Exception object that represents a noteworthy error
     * condition.
     * 
     * @param level
     *            The logging {@link Level level}.
    ...
    /**
     * Indicates if the logger is enabled at a given logging level. Message levels lower than this value will be
     * discarded.
     * 
     * @param level
     *            The logging {@link Level level}.
     * @return true if the logger is currently enabled for this logging level; false otherwise.
     */
